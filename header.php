...
<head>
    ...
    <title>ENEDI 17 - Escuelas de Diseño en Chile</title>
    ...
    <!-- HTML5 Shim and Respond.js IE8 zsupport of HTML5 elements and media queries -->
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-brand">
                <a href="index.php" onclick=$("#menu-close").click();>enedi<span>17</span></a>
            </li>
            <li>
            ...
            <li>
                <a href="contacto.php" onclick=$("#menu-close").click();>Services</a>
            </li>
        </ul>
    </nav>
